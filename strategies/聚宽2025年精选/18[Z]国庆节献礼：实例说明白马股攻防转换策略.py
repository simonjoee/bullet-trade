# ZZ
# 基于市场温度（市场环境）的动态股票投资策略。
#
# 策略通过沪深300指数的220日历史数据计算市场温度：
# - 寒冷 (cold): 当市场高度 < 0.20，表示市场处于底部区域
# - 温暖 (warm): 当60日最大值/最小值 > 1.20，表示市场处于正常状态
# - 炎热 (hot): 当市场高度 > 0.90，表示市场处于高位
#
# 股票筛选逻辑
# - 寒冷市场 (价值投资)：
#   - PB < 1 (破净股，低估值)
