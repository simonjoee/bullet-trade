...
# - 该策略通过以下方式筛选股票：
# - 一进二筛选: 昨日涨停但前两日未涨停的股票
# - 首板低开筛选: 昨日曾涨停但非涨停收盘的股票
# - 弱转强筛选: 昨日曾涨停但非涨停收盘的股票
#
# 3. 买入策略 (buy)
# - 一进二策略 (高开)
#   - 资金要求: 昨日成交额在5.5亿-20亿之间
#   - 市值要求: 总市值>70亿，流通市值<520亿
#   - 左压条件: 近期成交量不能低于前一日90%
#   - 高开条件: 开盘价在涨停价的1-1.06倍之间
#   - 集合竞价: 集合竞价成交量占前一日成交量3%以上
# - 首板低开策略
#   - 低开范围: 开盘价为前一日收盘价的95.5%-97%
#   - 成交额: 前一日成交额>=1亿
# - 弱转强策略
#   - 涨幅限制: 前4日涨幅不超过28%
#   - 收盘条件: 前一日收盘价不低于开盘价5%以上
#   - 其他条件: 类似一进二策略的条件
#
# 4. 卖出策略 (sell)
# - 上午11:25: 如果有盈利且未涨停则止盈
# - 下午14:50:
#   - 有盈利且未涨停则止盈
#   - 跌破5日均线则止损
