# ZZ：通过市值、净利润、营业收入等财务指标筛选10-100亿市值的优质小盘股，每周进行调仓。
# 1. 选股标准
# - 市值筛选: 10-100亿市值的股票
# - 财务筛选:
#   - 净利润 > 0
#   - 营业收入 > 1亿
#   - 归属于母公司所有者的净利润 > 0
#   - 股票池: 以399101.XSHE(国证A指)为基准
#
# 2. 股票过滤条件
# - 排除ST股票
# - 排除退市股票
# - 排除创业板(30开头)、科创板(68开头)等
# - 排除次新股(上市不足375天)
# - 排除涨停/跌停股票
#
# 3. 交易机制
...
#
# 4. 风险控制
# - 空仓月份: 1月和4月强制空仓，持有银华日利ETF(511880)
# - 动态仓位: 根据MA10指标动态调整持股数量(3-6只)
# - 涨停股管理: 昨日涨停股今日观察，如未涨停则卖出
