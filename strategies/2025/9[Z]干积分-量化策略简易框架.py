# ZZ：主要目标是通过基本面分析和市场技术指标来选择股票进行轮动投资
#
# 1. 月度选股及调仓：
# - 方向选择：
#   - 比较沪深300(大盘股)和中小板(小盘股)最近10天涨幅
#   - 两板块都强势(>10%) → 选涨幅大的
#   - 只有1个板块强势 → 选强势的
#   - 都不强 → 买外盘ETF(黄金、美股等)
# - 选股标准：按市值、ROE、市盈率等基本面指标筛选
#   - SMALL: 小市值策略 - 选择ROE>15%, ROA>10%的股票，按市值升序排列
#   - BIG: 大市值策略 - 市盈率0-30, 市销率0-8, 市现率<10等，按市值降序排列
#   - ROIC_BIG: 高ROIC大市值策略 - 总市值>300亿, ROA>15%, 负债率<50%等
#   - BM: 市净率策略 - 市值100-900亿, PB<10, ROE>20%等
#
# 2. 风控措施
# - 涨停打开止损：昨日涨停股票在当日未继续涨停则卖出
# - 价格止损：当股票价格跌破持仓成本的92%时止损
# - 补跌操作：对跌幅较小的股票进行补仓
# - 过滤ST、停牌、次新股
