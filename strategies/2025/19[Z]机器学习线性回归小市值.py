# ZZ：基于机器学习线性回归的量化选股策略，主要通过多个因子（如情绪类、质量类、技术指标等）对股票进行评分，然后选择评分较高的小市值股票进行投资。
#
# 1. 因子模型配置：策略使用了5组不同的因子组合，每组都有对应的系数：
# - ARBR-SGAI-NPtTORttm-RPps: 情绪、质量、盈利能力、每股指标
# - P1Y-TPtCR-VOL120: 动量、质量、情绪
# - PNF-TPtCR-ITR: 技术指标、质量、质量
# - DtA-OCtORR-DAVOL20-PNF-SG: 风格、质量、情绪、技术、风格
# - TVSTD6-CFpsttm-SR120-NONPttm: 情绪、每股指标、风险、基础科目
#
# 2. 核心选股逻辑
# - 因子评分: 使用线性回归模型计算每只股票的综合得分
# - 小市值筛选: 按总市值升序排列，选择市值最小的10%股票
# - 盈利筛选: 保留EPS(每股收益)大于0的股票
# - 风控过滤: 过滤ST、停牌、涨跌停等股票
#
# 3. 交易逻辑
# - 调仓频率: 每周一次
