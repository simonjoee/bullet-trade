# ZZ： 小市值策略，根据一致性决定是买还是卖
# 一致性指标试图捕捉以下市场状态：
# - 市场恐慌：当市场下跌但大部分股票跌幅相对一致时，可能预示着系统性风险
# - 市场亢奋：当市场上涨但一致性很高时，可能表示市场过热
# - 分化风险：当一致性降低时，市场可能进入不确定性较高的阶段
#
# 1. 选股逻辑 (get_stock_list)
# - 选择中小板指数成分股（399101.XSHE）
# - 按流通市值升序排列，选择前5只股票
# - 过滤ST股票和退市股票
# 2. 风控逻辑：
# - 熊市时启用一致性风控，牛市时关闭（上证指数在年线上方）
# - 当市场中位跌幅<-2% 且一致性指标超过上轨时 → 清仓
# - 当市场中位涨幅>2% 且一致性指标超过均值时 → 满仓
# 3. 交易逻辑
# - 周调仓：每周一进行调仓
# - 涨停板管理：14:00检查涨停股票，若涨停打开则卖出
# - 放量控制：若股票成交量超过过去60天最大量的90%，则卖出
# - 季节性控制：1月、4月、6月不交易（财报季避险）
# - 放量检测：避免异常放量股票
# - 一致性风控：核心风控机制
