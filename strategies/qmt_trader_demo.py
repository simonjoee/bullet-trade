...
class MyXtQuantTraderCallback(XtQuantTraderCallback):
    ...
    def on_order_error(self, order_error):
        ...
        :return:
        """
        # print("on order_error callback")or.error_msg}")
    ...
    def on_cancel_error(self, cancel_error):
        ...
        print(f"委托报错回调 {order_error.order_remark} {order_err
        """
...
if __name__ == '__main__':
    ...
    path = r'C:\平安证券量盈QMT策略交易平台2.0.8.0\userdata_mini'
    ...
    acc = StockAccount('326219378859', 'STOCK')
    # 创建交易回调类对象，并声明接收回调
